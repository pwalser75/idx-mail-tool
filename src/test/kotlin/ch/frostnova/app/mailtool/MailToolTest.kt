...
class MailToolTest {
    ...
    fun listMails() {
        ...
        assertThat(consoleOutput()).isEqualTo(
            ...
            - Order #123
              on 2022-12-30T20:13:27Z from orders@shop.com , 12345 bytes
            """.trimIndent()
        )
    }
    ...
    fun listRules() {
        ...
        assertThat(consoleOutput()).isEqualTo(
            ...
            Account: test
            - Rules:
              - Mails from sender "some.org" will be moved to folder "archive"
              - Mails from sender ".ru" will be deleted
            - No data retention rules configured yet
            """.trimIndent()
        )
    }
